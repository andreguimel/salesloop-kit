  ...
  return (
    <div className="p-6 md:p-8 space-y-8">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        ...
        <div className="p-6 rounded-2xl glass animate-fade-up" style={{ animationDelay: '250ms' }}>
          <div className="flex items-center gap-3 mb-4">
        ...
        <div className="p-6 rounded-2xl glass animate-fade-up" style={{ animationDelay: '300ms' }}>
          <div className="flex items-center gap-3 mb-4">
